...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-regions-and-widgets?sort=semver)](https://github.com/liberusoftware/module-cms-regions-and-widgets/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-regions-and-widgets/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-regions-and-widgets/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-regions-and-widgets
```
...
<a href="https://github.com/liberusoftware/module-cms-regions-and-widgets/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-regions-and-widgets" alt="Contributors to liberusoftware/module-cms-regions-and-widgets">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-regions-and-widgets/graphs/contributors).
